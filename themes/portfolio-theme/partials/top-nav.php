<div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          <a href="index.php" class="navbar-brand">Roberts</a>
          ...
          <ul class="nav navbar-nav">
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="themes">
                <li><a href="../default/">Home Landing Page</a></li>
                <li class="divider"></li>
                <li><a href="#/welcomeParallax">Welcome Parallax Section</a></li>
                <li><a href="#/parallax">Parallax Article</a></li>
                <li><a href="../cosmo/">Summary Article</a></li>
                <li><a href="../cyborg/">Custom Buttons Article</a></li>
              </ul>
            </li>
            <li>
              <a href="#">Help</a>
